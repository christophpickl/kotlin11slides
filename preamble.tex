...
%\usepackage{media9} % animated gifs
\usepackage{movie15}


%\definecolor{COLOR_RED}{RGB}{255,0,0}
...
% #1 ... the filename to be included (no suffix needed, relative to images/ folder)
% #2 ... caption below to be displayed
% #3 ... OPTIONAL: if set, overrides the width parameter
...
\lstset{
 morekeywords={if, else, fun, val, var, get, set, data, enum, when, inline, object, infix, override, is, init, typealias, sealed, annotation, suspend}
}
\lstset{%
